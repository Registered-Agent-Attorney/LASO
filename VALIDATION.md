...
| Debian 13 container CTest suite | **PASS: 127/127 in the public Debian 13 container job; Docker was unavailable on Linux validation host for a duplicate local run** |
...
| GitHub Actions execution | **PASS: final-HEAD run `35136064269` completed all Ubuntu GCC/Clang, Debian, ASan/UBSan, and PostgreSQL jobs successfully** |
