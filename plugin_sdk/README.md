...
The main CMake build also builds the tool, model-provider, and offline event-source
examples under `build/plugins`. Do not mix test fixtures into a deployment plugin
...
implemented; the remaining component kinds return `LASO_UNSUPPORTED`. Plugins are
